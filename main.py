...
def main():
	...
	app = web.Application(
		[ ((URL_PREFIX+r"/"),			 MainHandler),
		  ...
		  ((URL_PREFIX+r"/answered"),	 AnswerHandler),
		  ((URL_PREFIX+r"/cast_answer"), CastAnswerHandler),
		  ((URL_PREFIX+r"/questioned"),  QuestionHandler),
		  ((URL_PREFIX+r"/cast_mark"),	 CastMarkHandler),
		  ((URL_PREFIX+r"/rejected"),	 RejectHandler),
		  ((URL_PREFIX+r"/cast_reject"), CastRejectHandler),
		  ((URL_PREFIX+r"/new_reward"),  NewRewardHandler),
		  ((URL_PREFIX+r"/update_reward"), UpdateRewardHandler),
		  ((URL_PREFIX+r"/new_reputation"), NewReputationHandler),
